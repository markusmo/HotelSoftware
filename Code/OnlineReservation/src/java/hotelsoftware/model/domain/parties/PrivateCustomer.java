...
public class PrivateCustomer extends Customer implements IPrivateCustomer
{
     ...
     */
    public static IPrivateCustomer getPrivateCustomerByName(String firstname, String lastname) throws PrivateCustomerNotFoundException, GuestNotFoundException
    {

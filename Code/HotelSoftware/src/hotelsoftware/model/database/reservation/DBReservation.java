...
//    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final DBReservation other = (DBReservation) obj;
        if (this.id != other.id && (this.id == null || !this.id.equals(other.id)))
        {
            return false;
        }
        if ((this.reservationNumber == null) ? (other.reservationNumber != null) : !this.reservationNumber.equals(other.reservationNumber))
        {
            return false;
        }
        ...
        if (this.party != other.party && (this.party == null || !this.party.equals(other.party)))
        {
            return false;
        }
        ...
        if (this.reservationOptions != other.reservationOptions && (this.reservationOptions == null || !this.reservationOptions.equals(other.reservationOptions)))
        {
            return false;
        }
    ...
    public int hashCode()
    {
        ...
        hash = 17 * hash + (this.reservationNumber != null ? this.reservationNumber.hashCode() : 0);
        ...
        hash = 17 * hash + (this.party != null ? this.party.hashCode() : 0);
        hash = 17 * hash + (this.created != null ? this.created.hashCode() : 0);
        hash = 17 * hash + (this.user != null ? this.user.hashCode() : 0);
        hash = 17 * hash + (this.reservationItems != null ? this.reservationItems.hashCode() : 0);
        hash = 17 * hash + (this.reservationOptions != null ? this.reservationOptions.hashCode() : 0);
        hash = 17 * hash + (this.guests != null ? this.guests.hashCode() : 0);
        return hash;
    }

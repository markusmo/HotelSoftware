...
public class ServiceSaver {
    ...
    public void saveOrUpdate(Collection<ExtraService> extraServices, Collection<Habitation> habitations, Collection<ServiceType> serviceTypes) throws FailedToSaveToDatabaseException{

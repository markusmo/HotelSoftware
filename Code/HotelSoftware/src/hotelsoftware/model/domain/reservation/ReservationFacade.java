...
public class ReservationFacade
{
    ...
    {
        return (Set<Reservation>) DynamicMapper.mapCollection(DBReservation.getReservationsByName(
                fname, lname));
    }

    public Set<Reservation> getReservationsByNameApprox(String fname,
            String lname)
    {
        return (Set<Reservation>) DynamicMapper.mapCollection(DBReservation.getReservationsByNameApprox(
                fname, lname));
    }
    ...
    {
        return (Set<Reservation>) DynamicMapper.map(

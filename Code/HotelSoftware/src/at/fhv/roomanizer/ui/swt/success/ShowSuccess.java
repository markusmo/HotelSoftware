package at.fhv.roomanizer.ui.swt.success;
...
public class ShowSuccess extends Dialog {

	String _message;
	private Shell _dialog;

	public ShowSuccess(Shell parent, String message) {
		super(parent);
		_message = message;
	}
